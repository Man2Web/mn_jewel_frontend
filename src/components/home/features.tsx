...
const Features = () => {
  return (
    <section className="bg-brandSecondary px-6 py-8">
      <SectionSeperator
      ...
      <div className="grid grid-cols-2 grid-rows-2 lg:grid-cols-5 lg:grid-rows-1">
        <div className="flex flex-col items-center border border-l-0 border-t-0 border-brandColor p-4 lg:border-b-0">
        ...
        <div className="flex flex-col items-center border border-r-0 border-t-0 border-brandColor p-4 lg:border-b-0 lg:border-r-2">
          <span className="text-xl text-brandColor">
            <Repeat2Icon />
          </span>
        ...
        <div className="flex flex-col items-center border border-b-0 border-l-0 border-brandColor p-4 lg:border-t-0">
          <span className="text-xl text-brandColor">
            <BadgeCheckIcon />
          </span>
        ...
        <div className="flex flex-col items-center border border-b-0 border-r-0 border-brandColor p-4 lg:border-r-2 lg:border-t-0">
          <span className="text-xl text-brandColor">
            <HeartHandshakeIcon />
          </span>
