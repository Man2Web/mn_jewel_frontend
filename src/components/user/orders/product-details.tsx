  ...
  return (
    <div className="flex gap-2">
      ...
      <div className="text-sm md:text-lg">
        <h1 className="pb-2 font-serif text-xl">{productData?.product_Name}</h1>
        ...
        <div className="flex items-center gap-2">
          <p>Price: </p>
          <h1 className="font-serif">{Number(productData?.calculatedPrice.toFixed(2)).toLocaleString()} /-</h1>
        </div>
      </div>
    </div>
  )
