...
const TermsAndConditions = () => {
  return (
    <div className="px-4 py-6">
      <SectionSeperator title="Terms And Conditions" description="" />
      <div className="prose mx-auto max-w-none">
        <p className="text-sm text-gray-500">Last updated February 20, 2025</p>

        <h2>Agreement to Our Legal Terms</h2>
        <p>
          We are MN Jewel Park (&quot;Company,&quot; &quot;we,&quot; &quot;us,&quot; &quot;our&quot;), a company
          registered in India at 23, Arni Rd, Velapad, Vellore, Tamil Nadu 632001. We operate, as well as any other
          related products and services that refer or link to these legal terms (the &quot;Legal Terms&quot;)
          (collectively, the &quot;Services&quot;). You can contact us by phone at <strong>8056736999</strong>, email at{' '}
          <a href="mailto:admin@mnjewelpark.com">admin@mnjewelpark.com</a>, or by mail to 23, Arni Rd, Velapad, Vellore,
          Tamil Nadu 632001, India. These Legal Terms constitute a legally binding agreement made between you, whether
          personally or on behalf of an entity (&quot;you&quot;), and MN Jewel Park, concerning your access to and use
          ...
          PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY. Supplemental terms and conditions
          or documents that may be posted on the Services from time to time are hereby expressly incorporated herein by
          reference. We reserve the right, in our sole discretion, to make changes or modifications to these Legal Terms
          ...
          responsibility to periodically review these Legal Terms to stay informed of updates. You will be subject to,
          and will be deemed to have been made aware of and to have accepted, the changes in any revised Legal Terms by
          your continued use of the Services after the date such revised Legal Terms are posted. All users who are
          minors in the jurisdiction in which they reside (generally under the age of 18) must have the permission of,
          and be directly supervised by, their parent or guardian to use the Services. If you are a minor, you must have
          your parent or guardian read and agree to these Legal Terms prior to you using the Services. We recommend that
        ...
        <p>
          ...
          <a href="mailto:admin@mnjewelpark.com">admin@mnjewelpark.com</a>. If we ever grant you the permission to post,
        ...
        <p>
          ...
          Contributions may be viewable by other users of the Services and through third-party websites. When you create
        ...
        <ul>
          ...
          <li>
            ...
            your Contributions to use the name or likeness of each such person to enable inclusion and use of your
        ...
        <ol>
          ...
          <li>
            In our sole discretion and without limitation, notice, or liability, remove from the Services or otherwise
        ...
        <p>
          These Legal Terms shall be governed by and defined following the laws of India. MN Jewel Park and yourself
        ...
        <p>
          ...
          established by these Legal Terms to the jurisdiction of the India courts. MN Jewel Park shall also maintain
          the right to bring proceedings as to the substance of the matter in the courts of the country where you reside
          or, if these Legal Terms are entered into in the course of your trade or profession, the state of your
        ...
        <p>
          ...
          RESULT OF THE USE OF ANY CONTENT POSTED, TRANSMITTED, OR OTHERWISE MADE AVAILABLE VIA THE SERVICES. WE DO NOT
          WARRANT, ENDORSE, GUARANTEE, OR ASSUME RESPONSIBILITY FOR ANY PRODUCT OR SERVICE ADVERTISED OR OFFERED BY A
          THIRD PARTY THROUGH THE SERVICES, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN
